<template>
  <div class="bg-gray-800 text-gray-500">
    <div class="mx-auto max-w-lg md:max-w-2xl lg:max-w-6xl py-6">
      <p class="text-center text-lg">
        <strong>Follow & Contact</strong>
      </p>
      ...
      <p class="text-sm text-center"><strong>Guillex387 © 2021</strong> All rights reserved</p>
    </div>
  </div>
</template>
